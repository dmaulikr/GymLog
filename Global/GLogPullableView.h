...
@class GLogPullableView;

/**
 Protocol for objects that wish to be notified when the state of a
 GLogPullableView changes
 */
@protocol GLogPullableViewDelegate <NSObject>

/**
 Notifies of a changed state
 @param pView GLogPullableView whose state was changed
 @param opened The new state of the view
 */
- (void)GLogPullableView:(GLogPullableView *)pView didChangeState:(BOOL)opened;
 ...
 */
@interface GLogPullableView : UIView {
...
/**
 The view that is used as the handle for the GLogPullableView. You
...
/**
 ...
 state. You must set this before using the GLogPullableView.
 */
...
/**
 If set to YES, tapping the handle view will toggle the GLogPullableView.
 Default value is YES.
 */
@property (readwrite,assign) BOOL toggleOnTap;

/**
 If set to YES, the opening or closing of the GLogPullableView will
...
/**
 Delegate that will be notified when the GLogPullableView changes state.
 If the view is set to animate transitions, the delegate will be
 called only when the animation finishes.
 */
@property (unsafe_unretained) id<GLogPullableViewDelegate> delegate;

/**
 The current state of the `GLogPullableView`.
 */
@property (readonly, assign) BOOL opened;

/**
 Toggles the state of the GLogPullableView
